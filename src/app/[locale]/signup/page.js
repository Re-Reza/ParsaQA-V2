            ...
            <div className="mainContentContainer" style={{ paddingBottom: "9em" }}>
                ...
                <div className="d-flex justify-content-center mt-4">
                    ...
                    <div className="d-flex flex-column" style={{ minWidth: "30%" }}>
                        ...
                        <button className={styles["signinBtn"]}><Link href="/signup/confirm">ادامه</Link></button>
                        ...
                        <div>
                            ...
                            <div className="txt-lightBlue text-center mt-4"><Link href="/signin">ورود به حساب کاربری </Link></div>
                        </div>
                    </div>

                            ...
                            categoryList.map((l0item, l0Index) => <li className="mb-3 txt-c-normal fw-500" key={l0Index}>
                                {
                                    l0item.level1List ?
                                        ...
                                        :
                                        <div ><span className="me-2"> <VscCircle /></span>{l0item.title}</div>
                                }
                                {
                                            ...
                                            l0item.level1List.map((l1item, l1Index) => <li className="txt-muted mb-3" key={l1Index}>
                                                {
                                                    l1item.level2List ?
                                                        ...
                                                        :
                                                        <div ><span className="me-2"> <VscCircle /></span>{l1item.title}</div>
                                                }
                                                {
                                                            ...
                                                            l1item.level2List.map((l2item, l2Index) => <li key={l2Index} className="txt-muted mb-3 fw-400 fs-c-1">
                                                                {
                                                                    l2item.level3List ?
                                                                        ...
                                                                        :
                                                                        <div style={{ marginRight: "1.8em" }} ><span className="me-2"> <VscCircle /></span>{l2item.title}</div>
                                                                }
                                                                {
                                                                            ...
                                                                            l2item.level3List.map((l3item, l3Index) => <li key={l3Index} className="txt-muted mb-3">
                                                                                {
                                                                                    l3item.level4List ?
                                                                                        ...
                                                                                        :
                                                                                        <div style={{ marginRight: "2.7em" }} ><span className="me-2"> <VscCircle /></span>{l3item.title}</div>
                                                                                }
                                                                                {
                                                                                            ...
                                                                                            l3item.level4List.map((l4item, l4Index) => <li key={l4Index} className="txt-muted mb-3">
                                                                                                {
                                                                                                    l4item.level5List ?
                                                                                                        ...
                                                                                                        :
                                                                                                        <div style={{ marginRight: "3.6em" }} ><span className="me-2"> <VscCircle /></span>{l4item.title}</div>
                                                                                                }
                                                                                                {
                                                                                                            ...
                                                                                                            l4item.level5List.map((l5item, l5Index) => <li key={l5Index} className="txt-muted mb-3">
                                                                                                                {
                                                                                                                    l5item.level6List ?
                                                                                                                        ...
                                                                                                                        :
                                                                                                                        <div style={{ marginRight: "4.6em" }} ><span className="me-2"> <VscCircle /></span>{l5item.title}</div>
                                                                                                                }
                                                                                                                {
                                                                                                                    l5item.level6List && state["item" + l5Index + "level" + 6] == true ? <ul>
                                                                                                                        {
                                                                                                                            l5item.level6List.map((l6item, l6Index) => <li key={l6Index} className="txt-muted mb-3">
                                                                                                                                <div style={{ marginRight: "5.8em" }} ><span className="me-2"> <VscCircle /></span>{l6item.title}</div>
                                                                                                                            </li>)
                                                                                                                        }
                                                                                                                    </ul> : <></>
                                                                                                                }
